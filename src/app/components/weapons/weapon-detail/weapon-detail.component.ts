...
@Component({
  ...
  styleUrl: './weapon-detail.component.scss',
...
export class WeaponDetailComponent implements OnInit {
  ...
  loadWeaponDetail(category: string, name: string) {
    ...
    this.weaponsService.getWeaponDetails(category as any, decodeURIComponent(name)).subscribe({
      next: response => {
        ...
        perks: [
          {
            icons: ['32_11345f84'],
            description: 'Aumenta o dano mágico',
            title: '+2% de dano mágico',
          },
          {
            icons: ['32_9e923ff4'],
            description: 'Aumenta chance de crítico',
            title: '+1% de chance de crítico',
          },
        ],
      },
      {
        ...
        perks: [
          {
            icons: ['32_11345f84'],
            description: 'Aumenta o dano mágico',
            title: '+3% de dano mágico',
          },
          {
            icons: ['32_9e923ff4'],
            description: 'Aumenta chance de crítico',
            title: '+2% de chance de crítico',
          },
        ],
      },
      {
        ...
        perks: [
          {
            icons: ['32_11345f84'],
            description: 'Aumenta o dano mágico',
            title: '+4% de dano mágico',
          },
          {
            icons: ['32_9e923ff4'],
            description: 'Aumenta chance de crítico',
            title: '+3% de chance de crítico',
          },
          {
            icons: ['32_3d470603'],
            description: 'Aumenta velocidade de cast',
            title: '+1% de velocidade de cast',
          },
        ],
      },
      {
        ...
        perks: [
          {
            icons: ['32_11345f84'],
            description: 'Aumenta o dano mágico',
            title: '+5% de dano mágico',
          },
          {
            icons: ['32_9e923ff4'],
            description: 'Aumenta chance de crítico',
            title: '+4% de chance de crítico',
          },
          {
            icons: ['32_3d470603'],
            description: 'Aumenta velocidade de cast',
            title: '+2% de velocidade de cast',
          },
        ],
      },
      {
        ...
        perks: [
          {
            icons: ['32_11345f84'],
            description: 'Aumenta o dano mágico',
            title: '+6% de dano mágico',
          },
          {
            icons: ['32_9e923ff4'],
            description: 'Aumenta chance de crítico',
            title: '+5% de chance de crítico',
          },
          {
            icons: ['32_3d470603'],
            description: 'Aumenta velocidade de cast',
            title: '+3% de velocidade de cast',
          },
          {
            icons: ['32_079dabfd'],
            description: 'Aumenta resistência mágica',
            title: '+1% de resistência mágica',
          },
        ],
      },
      {
        ...
        perks: [
          {
            icons: ['32_11345f84'],
            description: 'Aumenta o dano mágico',
            title: '+7% de dano mágico',
          },
          {
            icons: ['32_9e923ff4'],
            description: 'Aumenta chance de crítico',
            title: '+6% de chance de crítico',
          },
          {
            icons: ['32_3d470603'],
            description: 'Aumenta velocidade de cast',
            title: '+4% de velocidade de cast',
          },
          {
            icons: ['32_079dabfd'],
            description: 'Aumenta resistência mágica',
            title: '+2% de resistência mágica',
          },
          {
            icons: ['32_11345f84'],
            description: 'Habilidade especial',
            title: 'Habilidade especial: Sanguine Burst',
          },
        ],
      },
    ];
  ...
  hasSelectedPerks(): boolean {
    ...
    return currentWeapon.levels.some(level => level.perks.some(perk => perk.selected));
  }
  ...
  async salvarSelecionados(): Promise<void> {
    ...
    try {
      ...
      const selectedPerks = currentWeapon.levels
        .map(level => ({
          level: level.level,
      ...
      if (response.success) {
        ...
        if (
          ...
          this.visitorMessage.set(
            'Percebi que você está tentando salvar suas maestrias de armas como visitante! Se você quer desfrutar de todas as funcionalidades da Taverna, é preciso se registrar!'
          );
    ...
    savedPerks.forEach(savedLevel => {
      ...
      if (level && savedLevel.selectedPerks.length > 0) {
        ...
        savedLevel.selectedPerks.forEach(savedPerk => {
          const perk = level.perks.find(
            p => p.description === savedPerk.description && p.title === savedPerk.title
          );
          if (perk) {
            perk.selected = true;
            level.selectedPerk = perk.description;
